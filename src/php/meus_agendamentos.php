...
if (isset($_SESSION["email"])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th>Nome</th><th>Email</th><th>Funcionário</th><th>Data</th><th>Hora</th><th>Serviço</th><th>Numero do Agendamento</th></tr>";
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row['descricao_servico'] . "</td>"; // Adicionando a coluna do serviço
